        ...
        <div className='flex h-[calc(100vh-100px)] items-center justify-center'>
            <div className='bg-zinc-800 max-w-md w-full p-10 rounded-md'>
                ...
                <form onSubmit={onSubmit}>
                    ...
                    } placeholder="Email" className="w-full mb-5 bg-zinc-700 text-white px-4 py-2 rounded-md" />
                    {
                        errors.email && (
                    ...
                    } placeholder="Password" className="w-full mb-2 bg-zinc-700 text-white px-4 py-2 rounded-md" />
                    {
                        errors.password && (
